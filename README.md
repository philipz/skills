...
[![skills.sh](https://skills.sh/b/philipz/skills)](https://skills.sh/philipz/skills)
...
```bash
npx skills@latest add philipz/skills
```
...
- **[requirements-engineer](./skills/requirements-engineer/SKILL.md)** — Requirements analysis and documentation specialist bridging business stakeholders and technical teams. Aligned with IEEE 29148 and BABOK v3.
...
Skills for managing personal documents and notes.
